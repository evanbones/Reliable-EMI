    ...
    public static void onLayout() {
        ...
        if (theme == TabTheme.HORIZONTAL) {
            ...
            if (ReliableEmiConfig.maxSidebarTabs == 0) {
                tabCount = Mth.clamp(availableWidth / ReliableEmiConfig.horizontalTabsWidth, 1, totalTabCount);
            ...
            if (ReliableEmiConfig.maxSidebarTabs == 0) {
                tabCount = Mth.clamp(availableHeight / ReliableEmiConfig.verticalTabsHeight, 1, totalTabCount);
